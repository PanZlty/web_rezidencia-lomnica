<?php
/**
 * Image Map Pro styles loaded as a MU-plugin module.
 */
...
add_action('wp_enqueue_scripts', static function () {
    ...
    wp_register_style('rezidencia-lomnica-image-map-styles', false, [], null);
    wp_enqueue_style('rezidencia-lomnica-image-map-styles');
    wp_add_inline_style('rezidencia-lomnica-image-map-styles', <<<'CSS'
/* Rezidencia Lomnica Image Map Pro */

/* Dropdown / layers select */
...
.imp-ui-layers-select:hover {
  ...
  border-color: var(--neutral-dark, #202a2f) !important;
  color: #fff !important;
}
...
.imp-fullscreen-button svg.imp-icon {
  fill: var(--text-dark, #2b3438) !important;
}

.imp-fullscreen-button:hover svg.imp-icon,
.imp-fullscreen-button:hover .imp-fullscreen-label {
  fill: #fff !important;
  color: #fff !important;
}

/* Tooltip shadow - safe version, no global overflow override */
.imp-tooltip {
